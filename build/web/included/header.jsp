<%-- 
    Document   : header
    Created on : 10-05-2022, 16:42:51
    Author     : hanhu
--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>


<header class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
        id="sidenavAccordion">
    <c:if test="${sessionScope.LOGIN_USER!=null}">
        <button class="btn btn-icon btn-transparent-dark order-1 order-lg-0 me-2 ms-lg-2 me-lg-0" id="sidebarToggle"><i data-feather="menu"></i></button>
        </c:if>
    <a class="navbar-brand pe-3 ps-4 ps-lg-2 h-100" href="dashBoard">
        <img height="32px" class="h-100" src="assets/img/logo.png" alt="FPT University"></a>
    ...
    <c:choose>
                ...
                <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                    <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
                       ...
                       aria-expanded="false"><img class="img-fluid"
                                               src="${sessionScope.LOGIN_USER.getAvatar_link()!=null?sessionScope.LOGIN_USER.getAvatar_link():!sessionScope.LOGIN_USER.isGender()?"assets/img/illustrations/profiles/profile-1.png":"assets/img/illustrations/profiles/profile-2.png"}" /></a>
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                         aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            <img class="dropdown-user-img" src="${sessionScope.LOGIN_USER.getAvatar_link()!=null?sessionScope.LOGIN_USER.getAvatar_link():!sessionScope.LOGIN_USER.isGender()?"assets/img/illustrations/profiles/profile-1.png":"assets/img/illustrations/profiles/profile-2.png"}" />
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name">${sessionScope.LOGIN_USER.getFull_name()}</div>
                                <div class="dropdown-user-details-email">${sessionScope.LOGIN_USER.getEmail()}</div>
                            </div>
                        </h6>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="profile?service=profile">
                            <div class="dropdown-item-icon"><i data-feather="settings"></i></div>
                            Account
                        </a>
                        <a class="dropdown-item"  data-bs-toggle="modal" href="#Logout">
        ...
        <c:otherwise>
            <ul class="navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                    <a class="btn btn-primary" href="login?service=loginPage">Sign In</a>
                </li>
            </ul>
        </c:otherwise>
    </c:choose>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="login?service=logout" class="btn btn-danger">Logout</a>
            </div>
        </div>
    </div>
</div>