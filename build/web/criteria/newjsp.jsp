                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-xl-3 col-md-6 d-flex flex-column justify-content-between">
                                                    ...
                                                    <div id="team_evalCriteria">
                                                        <input ${loginUser.getRole_id()<2?"":"disabled=''"} onchange="changeStatus('team_eval', 'Team', 'Member')"${loginUser.getRole_id()<2?"":"disabled=''"} type="checkbox" class="btn-check" id="team_eval" name="team_eval" autocomplete="off"  ${criteriaChoose!=null&&criteriaChoose.isTeam_evaluation()?"checked":""}>
                                                ...
                                                <div class="mb-3 col-xl-3 col-md-6 d-flex flex-column justify-content-between">
                                                    ...
                                                    <div id="statusClassUser">
                                                        <input ${loginUser.getRole_id()<2?"":"disabled=''"} onchange="changeStatus('status', 'Activate', 'Deactivate')"${loginUser.getRole_id()<2?"":"disabled=''"} type="checkbox" class="btn-check" id="status" name="status" autocomplete="off" ${criteriaChoose!=null&&criteriaChoose.isStatus()?"checked=''":""}>
